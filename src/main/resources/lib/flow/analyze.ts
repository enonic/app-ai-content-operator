...
const isErrorResult = (result: RawAnalysisResult): result is AnalysisErrorResult =>
  SPECIAL_KEYS.error in result;
const isUnclearResult = (result: RawAnalysisResult): result is AnalysisUnclearResult =>
  SPECIAL_KEYS.unclear in result;

export function isWarningResult(
  result: RawAnalysisResult,
): result is AnalysisErrorResult | AnalysisUnclearResult {
