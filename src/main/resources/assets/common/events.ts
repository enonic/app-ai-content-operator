...
export function addGlobalOpenDialogHandler(
  handler: CustomEventHandler<OpenDialogEventData>,
): FnVoid {
  return addGlobalHandler(AiEvents.OPEN_DIALOG, handler);
}

export function addGlobalSetContextHandler(
  handler: CustomEventHandler<SetContextEventData>,
): FnVoid {
